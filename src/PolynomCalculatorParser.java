...
public class PolynomCalculatorParser extends Parser {
	...
	public static final int
		...
		RULE_szamAddop = 8, RULE_szamMulop = 9, RULE_szamFct = 10, RULE_szamVagySzamValtozo = 11;
	private static String[] makeRuleNames() {
		return new String[] {
			"start", "line", "valtozoErtekadas", "polinomDeklaracio", "szamValtozoDeklaracio", 
			"polinom", "xtag", "szamExpr", "szamAddop", "szamMulop", "szamFct", "szamVagySzamValtozo"
		};
	}
	...
	public final SzamVagySzamValtozoContext szamVagySzamValtozo() throws RecognitionException {
		...
		enterRule(_localctx, 22, RULE_szamVagySzamValtozo);
		try {
			setState(206);
			_errHandler.sync(this);
			switch (_input.LA(1)) {
