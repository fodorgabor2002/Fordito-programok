grammar PolynomCalculator_copy;
...
xtag returns [XTag xtagPeldany]
    ...
    //| szamExprSzamValtozoval {$xtagPeldany.egyutthato = String.valueOf($szamExprSzamValtozoval.egyutthatosResz);}
    //| csakValtozo {$xtagPeldany.egyutthato = String.valueOf($csakValtozo.egyutthatosResz);}
    //| szamExpr {$xtagPeldany.egyutthato = String.valueOf($szamExpr.value);}
    ;

szamExprSzamValtozoval returns[String egyutthatosResz]
    : szorzo = szamExpr ('*')? VALTOZO { $egyutthatosResz = String.valueOf($szorzo.value * szamValtozok.get($VALTOZO.text));}
    ;

csakValtozo returns[String egyutthatosResz]
    : VALTOZO { $egyutthatosResz = String.valueOf(szamValtozok.get($VALTOZO.text));}
    ;
